...
@export var sway_amount : float = 0.004
@export var sway_rotation : float = 0.004
...
@export var bob_slant : float = 0.03
...
func _process(delta):
	...
	if not GlobalEvents.in_cutscene and not GlobalEvents.telefone_cutscene_active:
